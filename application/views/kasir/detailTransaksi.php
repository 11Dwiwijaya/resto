    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-3">
        <nav nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('kasir/transaksi')?>">Riwayat Transaksi</a></li>
                    ...
                    <table class="table table-bordered table-hover" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $d['jumlah_harga'] * $d['jumlah_pesanan']; ?></td>

                            </tr>
                            <?php 
                                    $tot = $d['jumlah_harga'] * $d['jumlah_pesanan'];
                                    $total += $tot;
                                    ?>
                            <?php endforeach; ?>
